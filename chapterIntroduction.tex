...
\begin{tabular}{l|l|l|l|l}
									...
									& Device type		& Responsivity				& Bandwidth			& Quantum efficiency	\\
\textbf{Graphene}					& Bolometric		& $~0.2 mAW^{-1} (RT)$		& >1 GHz			& -						\\
Zero bandgap						&					& $~10^5 VW^{-1} (LT)$		& -					& -						\\
Broadband							& Photoconduction	& $~0.1 mAW^{-1} $			& -					& -						\\
Mainly based on photothermal		& Heterojunction	& $~10 mAW^{-1} $			& >40 GHz			& 1-10\% (E)			\\
with weak photovoltaic element		& 					& $~100 mAW^{-1}$			& >20 Ghz			& 10-30\% (I)			\\
High dark current					& 					& (waveguide)				& 					&					\\\hline
\textbf{2DTMDs}						& Photoconduction	& 							&					&						\\	
