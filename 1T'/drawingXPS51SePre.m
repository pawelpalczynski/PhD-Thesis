...
plot(XPS51SePre(:, 1), XPS51SePre(:, 4), 'LineWidth', 2, 'Color', c(3,:), 'HandleVisibility','off');
plot(XPS51SePre(:, 1), XPS51SePre(:, 5), 'LineWidth', 2, 'Color', c(4,:));
plot(XPS51SePre(:, 1), XPS51SePre(:, 6), 'LineWidth', 2, 'Color', c(4,:), 'HandleVisibility','off');
plot(XPS51SePre(:, 1), XPS51SePre(:, 7), 'LineWidth', 2, 'Color', c(5,:));
plot(XPS51SePre(:, 1), XPS51SePre(:, 8), 'LineWidth', 2, 'Color', c(5,:), 'HandleVisibility','off');
plot(XPS51SePre(:, 1), XPS51SePre(:, 9), 'LineWidth', 2, 'Color', c(6,:));
plot(XPS51SePre(:, 1), XPS51SePre(:, 10), 'LineWidth', 2, 'Color', c(6,:), 'HandleVisibility','off');
...
legend('Measurment', 'Total fit', 'Amorphous Se', '1T WSe_2', 'Phosphines',  '2H WSe_2', 'Location', 'NorthEast')
