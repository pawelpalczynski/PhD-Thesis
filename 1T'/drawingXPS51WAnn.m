...
plot(XPS51WAnn(:, 1), XPS51WAnn(:, 4), 'LineWidth', 2, 'Color', c(3,:));
plot(XPS51WAnn(:, 1), XPS51WAnn(:, 5), 'LineWidth', 2, 'Color', c(4,:));
plot(XPS51WAnn(:, 1), XPS51WAnn(:, 6), 'LineWidth', 2, 'Color', c(4,:));
plot(XPS51WAnn(:, 1), XPS51WAnn(:, 7), 'LineWidth', 2, 'Color', c(5,:));
plot(XPS51WAnn(:, 1), XPS51WAnn(:, 8), 'LineWidth', 2, 'Color', c(5,:));
