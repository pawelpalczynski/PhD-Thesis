...
plot(XPS51WPre2(:, 1), XPS51WPre2(:, 4), 'LineWidth', 2, 'Color', c(3,:), 'HandleVisibility','off');
plot(XPS51WPre2(:, 1), XPS51WPre2(:, 5), 'LineWidth', 2, 'Color', c(4,:));
plot(XPS51WPre2(:, 1), XPS51WPre2(:, 6), 'LineWidth', 2, 'Color', c(4,:), 'HandleVisibility','off');
plot(XPS51WPre2(:, 1), XPS51WPre2(:, 7), 'LineWidth', 2, 'Color', c(5,:));
plot(XPS51WPre2(:, 1), XPS51WPre2(:, 8), 'LineWidth', 2, 'Color', c(5,:), 'HandleVisibility','off');
plot(XPS51WPre2(:, 1), XPS51WPre2(:, 9), 'LineWidth', 2, 'Color', c(6,:));
plot(XPS51WPre2(:, 1), XPS51WPre2(:, 10), 'LineWidth', 2, 'Color', c(6,:), 'HandleVisibility','off');
...
legend('Measurment', 'Total fit', '1T WSe_2', 'WO_3', '2H WSe_2', 'WO_3', 'Location', 'NorthEast')
