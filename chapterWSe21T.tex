...
The 1T' $WSe_2$ has been grown via the colloidal synthesis route with flakes with average diameter of 200 nm. The sample has then been characterised using Raman spectroscopy, XPS, TEM, and KPFM.